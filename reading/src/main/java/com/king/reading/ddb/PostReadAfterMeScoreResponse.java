...
public class PostReadAfterMeScoreResponse {
	...
	public PostReadAfterMeScoreResponse(String reserved) {
		this.reserved = reserved;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof PostReadAfterMeScoreResponse)) {
			return false;
		}
		PostReadAfterMeScoreResponse other = (PostReadAfterMeScoreResponse) obj;
		return (
