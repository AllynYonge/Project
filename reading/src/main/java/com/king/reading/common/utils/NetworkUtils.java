...
public class NetworkUtils {
    ...
    public static NetType getConnectedType(Context context) {
        NetType netWorkType = NetType.NETWORKTYPE_INVALID;
        ...
        try {
            ...
            if (networkInfo != null && networkInfo.isConnected()) {
                ...
                if (type.equalsIgnoreCase("WIFI")) {
                    netWorkType = NetType.NETWORKTYPE_WIFI;
                } else if (type.equalsIgnoreCase("MOBILE")) {
                    String proxyHost = android.net.Proxy.getDefaultHost();
                    netWorkType = TextUtils.isEmpty(proxyHost) ? getWapNetWork(context) : NetType.NETWORKTYPE_WAP;
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private static NetType getWapNetWork(Context context) {
        TelephonyManager telephonyManager = (TelephonyManager) context.getSystemService(Context.TELEPHONY_SERVICE);
        switch (telephonyManager.getNetworkType()) {
            case TelephonyManager.NETWORK_TYPE_1xRTT:
                return NetType.NETWORKTYPE_2G; // ~ 50-100 kbps
            case TelephonyManager.NETWORK_TYPE_CDMA:
                return NetType.NETWORKTYPE_2G; // ~ 14-64 kbps
            case TelephonyManager.NETWORK_TYPE_EDGE:
                return NetType.NETWORKTYPE_2G; // ~ 50-100 kbps
            case TelephonyManager.NETWORK_TYPE_GPRS:
                return NetType.NETWORKTYPE_2G; // ~ 100 kbps
            case TelephonyManager.NETWORK_TYPE_IDEN:
                return NetType.NETWORKTYPE_2G; // ~25 kbps

            case TelephonyManager.NETWORK_TYPE_EVDO_0:
                return NetType.NETWORKTYPE_3G; // ~ 400-1000 kbps
            case TelephonyManager.NETWORK_TYPE_EVDO_A:
                return NetType.NETWORKTYPE_3G; // ~ 600-1400 kbps
            case TelephonyManager.NETWORK_TYPE_HSDPA:
                return NetType.NETWORKTYPE_3G; // ~ 2-14 Mbps
            case TelephonyManager.NETWORK_TYPE_HSPA:
                return NetType.NETWORKTYPE_3G; // ~ 700-1700 kbps
            case TelephonyManager.NETWORK_TYPE_HSUPA:
                return NetType.NETWORKTYPE_3G; // ~ 1-23 Mbps
            case TelephonyManager.NETWORK_TYPE_UMTS:
                return NetType.NETWORKTYPE_3G; // ~ 400-7000 kbps
            case TelephonyManager.NETWORK_TYPE_EHRPD:
                return NetType.NETWORKTYPE_3G; // ~ 1-2 Mbps
            case TelephonyManager.NETWORK_TYPE_EVDO_B:
                return NetType.NETWORKTYPE_3G; // ~ 5 Mbps
            case TelephonyManager.NETWORK_TYPE_HSPAP:
                return NetType.NETWORKTYPE_3G; // ~ 10-20 Mbps

            case TelephonyManager.NETWORK_TYPE_LTE:
                return NetType.NETWORKTYPE_4G; // ~ 10+ Mbps

            case TelephonyManager.NETWORK_TYPE_UNKNOWN:
                return NetType.NETWORKTYPE_UNKNOW;
            default:
                return NetType.NETWORKTYPE_UNKNOW;
        }
    }
