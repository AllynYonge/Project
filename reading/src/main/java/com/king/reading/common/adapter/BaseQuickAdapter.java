...
import com.king.reading.common.adapter.animation.AlphaInAnimation;
import com.king.reading.common.adapter.animation.BaseAnimation;
import com.king.reading.common.adapter.animation.ScaleInAnimation;
import com.king.reading.common.adapter.animation.SlideInBottomAnimation;
import com.king.reading.common.adapter.animation.SlideInLeftAnimation;
import com.king.reading.common.adapter.animation.SlideInRightAnimation;
import com.king.reading.common.adapter.entity.IExpandable;
import com.king.reading.common.adapter.loadmore.LoadMoreView;
import com.king.reading.common.adapter.loadmore.SimpleLoadMoreView;
import com.king.reading.common.adapter.util.MultiTypeDelegate;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    /**
     * 调用该方法表示已经加载完了，参数TRUE或FALSE表示是否展示底部加载完成的控件
     *
