...
import com.king.reading.widget.drawer.holder.DimenHolder;
import com.king.reading.widget.drawer.holder.ImageHolder;
import com.king.reading.widget.drawer.holder.StringHolder;
import com.king.reading.widget.drawer.model.AbstractDrawerItem;
import com.king.reading.widget.drawer.model.ContainerDrawerItem;
import com.king.reading.widget.drawer.model.interfaces.Badgeable;
import com.king.reading.widget.drawer.model.interfaces.IDrawerItem;
import com.king.reading.widget.drawer.model.interfaces.Iconable;
import com.king.reading.widget.drawer.model.interfaces.Nameable;
...
public class Drawer {
    ...
    /*
     * set the current selection in the drawer
     * NOTE: this also deselects all other selections. if you do not want this. use the direct api of the adater .createAdapter().select(position, fireOnClick)
     * NOTE: This will trigger onDrawerItemSelected without a view if you pass fireOnClick = true;
     *
     * @param position
     * @param fireOnClick
