package com.king.reading.widget.badgeview;
...
public class QBadgeView extends View implements Badge {
    ...
    private void init() {
        ...
        mGravityOffsetX = DensityUtils.dp2px(getContext(), 5);
        mGravityOffsetY = DensityUtils.dp2px(getContext(), 5);
        ...
        switch (event.getActionMasked()) {
            ...
            case MotionEvent.ACTION_POINTER_DOWN:
                ...
                if (mDraggable && event.getPointerId(event.getActionIndex()) == 0
                    ...
                    mDefalutRadius = DensityUtils.dp2px(getContext(), 7);
