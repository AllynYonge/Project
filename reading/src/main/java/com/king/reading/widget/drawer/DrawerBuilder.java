...
import com.king.reading.widget.drawer.model.interfaces.Selectable;
import com.king.reading.widget.drawer.util.DensityUtils;
import com.king.reading.widget.drawer.util.DrawerUIUtils;
...
public class DrawerBuilder {
    ...
    public DrawerBuilder withDrawerWidthDp(int drawerWidthDp) {
        ...
        this.mDrawerWidth = DensityUtils.dp2px(mActivity, drawerWidthDp);
        return this;
    }
     ...
     * You can disable this at a later time via .createAdapter().withMultiSelect(false)
