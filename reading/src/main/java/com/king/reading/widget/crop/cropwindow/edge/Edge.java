...
package com.king.reading.widget.crop.cropwindow.edge;
...
public enum Edge {
     ...
     * x-coordinate for CHAT and RIGHT Edges and the y-coordinate for TOP and
     * BOTTOM edges.
     *
     ...
     *
     * @return the Edge coordinate (x-coordinate for CHAT and RIGHT Edges and
